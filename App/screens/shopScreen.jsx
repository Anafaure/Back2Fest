...
import { View, Image, Text, StyleSheet, SafeAreaView, ScrollView, TouchableOpacity, FlatList } from 'react-native';
import { Ionicons } from '@expo/vector-icons';
import { useNavigation } from '@react-navigation/native';

const items = [
    { name: 'Coca-Cola (Canette)', price: '1.50€', image: require('../assets/Coca-Cola.png'), category: 'Boissons' },
    { name: 'Lays (Chips)', price: '4€', image: require('../assets/chips.png'), category: 'Snacks' },
    { name: 'Sandwich', price: '7€', image: require('../assets/sandwich.png'), category: 'Sandwichs' },
    { name: 'Desperados (Bière)', price: '2€', image: require('../assets/biere.png'), category: 'Alcools' },
    { name: 'Frites', price: '2€', image: require('../assets/frites.png'), category: 'Snacks' },
    { name: 'Burger', price: '4€', image: require('../assets/burger.png'), category: 'Sandwichs' }
];
...
function ActionButton({ label, selected, onPress }) {
    return (
        <TouchableOpacity
            style={[styles.actionButton, { backgroundColor: selected ? '#F72585' : '#121212' }]}
            onPress={onPress}
        >
            <Text style={[styles.buttonText, { color: selected ? '#121212' : 'white' }]}>{label}</Text>
        </TouchableOpacity>
    );
}
